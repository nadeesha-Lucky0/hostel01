...
import { HiOutlineHome, HiOutlineDocumentChartBar, HiOutlineMoon, HiOutlineSun, HiOutlineArrowRightOnRectangle, HiOutlineUserGroup, HiOutlineBars3, HiOutlineXMark } from 'react-icons/hi2'
import logo from '../assets/idHsN22NWk_logos.png'
import { useAuth } from '../context/AuthContext'

const navItems = [
    { to: '/financial/dashboard', icon: HiOutlineHome, label: 'Dashboard' },
    { to: '/profiles', icon: HiOutlineUserGroup, label: 'Student Profiles' },
                ...
                <div className={`absolute top-0 right-0 w-[280px] h-full bg-[#1A3263] dark:bg-slate-900 shadow-2xl transition-transform duration-500 ease-out flex flex-col ${isMenuOpen ? 'translate-x-0' : 'translate-x-full'}`}>
                    <div className="p-6 border-b border-white/10 flex items-center justify-between">
                        <div>
                            ...
                            <div className="text-lg font-black text-white tracking-tight">Finance Portal</div>
                        </div>
